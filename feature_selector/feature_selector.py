...
class FeatureSelector():
    ...
    def plot_collinear(self, plot_all = False):
        ...
        ax.set_yticklabels(list(corr_matrix_plot.index), size = int(40 / corr_matrix_plot.shape[0]))

        # Set the xlabels 
        ax.set_xticks([x + 0.5 for x in list(range(corr_matrix_plot.shape[1]))])
        ax.set_xticklabels(list(corr_matrix_plot.columns), size = int(40 / corr_matrix_plot.shape[1]))
